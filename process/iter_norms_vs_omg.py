...
def omg_norms_iter(dirarg, no_of_sims):
    ...
    for i in range(0, no_of_sims):
        ...
        [psi1_cat, psi2_cat, norms_1, norms_2, deln_r0, times, theory_omg1, theory_omg2] = load_in_cal_norms(dirarg_current, i+1)
...
if __name__ == '__main__':
    ...
    omg_norms_iter(args.READ_PATH[0], args.SIM_NUM[0])
