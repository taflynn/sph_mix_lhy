...
def time(json_input):
    ...
    if DENS_LCK == 1:
        ...
        if m1 == m2:
            ...
            = rk4_dens_ulck(r,psi1_0,psi2_0,V1,V2,alpha,beta,eta,N1_rescale,N2_rescale,dr,dt,IM_T_STEPS,T_SAVE,0,BC_TYPE,setup['T_DEPEN_POT'])
            psi1_im = psi1_gs
            psi2_im = psi2_gs
            if RE_T_STEPS > 0:
                lamb = 0.0001
            ...
            = rk4_dens_ulck(r,psi1_im,psi2_im,V1,V2,alpha,beta,eta,N1_rescale,N2_rescale,dr,dt,RE_T_STEPS,T_SAVE,1,BC_TYPE,setup['T_DEPEN_POT'])
